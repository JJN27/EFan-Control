...
// accessor & setter
- (BOOL)showTempAsFahrenheit
{
    return showTempAsFahrenheit;
}
- (void)setShowTempAsFahrenheit:(BOOL)newShowTempAsFahrenheit
{
    showTempAsFahrenheit = newShowTempAsFahrenheit;
}
